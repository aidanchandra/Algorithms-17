public final class States {
	...
	public static void main(String[] args) {
		for (SymbolGraph.Vertex v : graph) {
			for (SymbolGraph.Vertex w : v.neighbors()) {
				State a = States.find(v.name());
				State b = States.find(w.name());
				int distance = (int) a.capital().distance(b.capital());
				System.out.println(a.code() + ", " + b.code() + ": " + distance);
				// System.out.println(v.name() + ", " +  w.name());
				// System.out.println(a.code() + ": " + a.capital().name());
				// System.out.println(b.code() + ": " + b.capital().name());
			}
		}
	}
