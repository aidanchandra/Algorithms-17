...
public class Assignment{
    ...
    public class Equal extends BinaryOperator{
        ...
        public Equal (Variable firstOperand, Node secondOperand){
            ...
            //Main.variables.put(firstOperand.symbol, secondOperand.evaluate());
        ...
        public int evaluate(Node firstValue, Node secondValue){ //FirstValue will NEED to be a variable according to our constructor    
            ...
            Main.variables.put(varReference, secondValue.evaluate());
            return Main.variables.get(varReference);
        }
        @Override
    ...
    public class plusEqual extends BinaryOperator{
        ...
        public int evaluate(Node firstValue, Node secondValue){
            ...
            Main.variables.put(varReference, firstValue.evaluate() + secondValue.evaluate()); //firstValue OR var????
            return Main.variables.get(varReference);
    ...
    public class minusEqual extends BinaryOperator{
        ...
        public int evaluate(Node firstValue, Node secondValue){
            ...
            Main.variables.put(varReference, firstValue.evaluate() - firstValue.evaluate());
            return Main.variables.get(varReference);
            //How to do the actual setting equal - I cant visualize it
    ...
    public class timesEqual extends BinaryOperator{
        String varReference;
        public timesEqual (Variable firstOperand, Operand secondOperand){
            super(firstOperand, secondOperand);
            varReference = firstOperand.symbol;
        }
        ...
        public int evaluate(Node firstValue, Node secondValue){
            ...
            Main.variables.put(varReference, firstValue.evaluate() * secondValue.evaluate());
            return Main.variables.get(varReference);
            //How to do the actual setting equal - I cant visualize it
    ...
    public class divEqual extends BinaryOperator{
        String varReference;
        public divEqual (Variable firstOperand, Operand secondOperand){
            super(firstOperand, secondOperand);
            Main.variables.put(firstOperand.symbol, secondOperand.evaluate());
            varReference = firstOperand.symbol;
        }
    ...
    public class modEqual extends BinaryOperator{
        String varReference;
        public modEqual (Variable firstOperand, Operand secondOperand){
            super(firstOperand, secondOperand);
            //Main.variables.put(firstOperand.symbol, secondOperand.evaluate());
            varReference = firstOperand.symbol;
        }
