...
public class Sorter {
    ...
    private static int radix = 4;					// value for radix sorts.
    ...
    //	-td_merge		// top-down mergesort (abbreviation: -td)s
    //	-bu_merge		// bottom-up mergesort (abbreivate: -bu)
    //	-lsd_radix		// lt significant digit first radix sort (-lsd)
    ...
    //	-min n			// Minimum value for array elements (defauslt 0)
    ...
    public static void main(String[] args) {
        ...
        for (String arg : args) {
            switch (arg) {
                case "-rand":
                    rand = true;
                    int toGet = (int) (Math.random() * 10) + 1; //1 to 8
